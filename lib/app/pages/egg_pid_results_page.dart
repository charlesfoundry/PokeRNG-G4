...
class EggPidResultsPage extends StatefulWidget {
  ...
  @override
  State<EggPidResultsPage> createState() => _EggPidResultsPageState();
}

class _EggPidResultsPageState extends State<EggPidResultsPage> {
  EggPidSearchJob? _job;
  Gen4SearchRunState _state = Gen4SearchRunState.running;
  Gen4SearchProgress? _progress;
  List<EggPidSearchResult> _results = const [];
  ...
  Future<void> _startSearch() async {
    try {
      _job = await EggPidSearchJob.start(
...
class _EggPidResultCard extends StatelessWidget {
  ...
  final EggPidSearchResult result;
