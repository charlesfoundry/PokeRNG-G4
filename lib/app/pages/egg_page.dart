...
import '../egg_pickup_search_job.dart';
...
import 'egg_pickup_results_page.dart';
import 'egg_pid_results_page.dart';
...
class _EggPageState extends State<EggPage> {
  ...
  EggPidSearchResult? _selectedHeldHit;
  ...
  @override
  void didUpdateWidget(covariant EggPage oldWidget) {
      ...
      children: [
        _ResponsiveGrid(
          children: [
            ...
            TextField(
              controller: _heldInitialAdvanceFilterController,
              decoration: InputDecoration(labelText: l10n.initialAdvanceFilter),
              keyboardType: TextInputType.number,
              inputFormatters: platformDigitOnlyInputFormatters(),
              onChanged: (_) => _refreshHeldSeedSearch(),
            ),
      ...
      children: [
        _ResponsiveGrid(
          children: [
            ...
            TextField(
              controller: _pickupInitialAdvanceFilterController,
              decoration: InputDecoration(labelText: l10n.initialAdvanceFilter),
              keyboardType: TextInputType.number,
              inputFormatters: platformDigitOnlyInputFormatters(),
              onChanged: (_) => _refreshPickupSeedSearch(),
  ...
  Future<void> _searchHeld() async {
    ...
    try {
      ...
      final result = await Navigator.of(context).push<EggPidSearchResult>(
        MaterialPageRoute(
          builder: (_) => EggPidResultsPage(
            request: EggPidSearchRequest(
              year: year,
              minDelay: minDelay,
              maxDelay: maxDelay,
              tid: tid,
  ...
  Future<void> _generatePickup() async {
    ...
    try {
      ...
      final tid = _parseU16(_tidController.text, l10n.trainerId);
      final sid = _parseU16(_sidController.text, l10n.secretId);
      final result = await Navigator.of(context).push<EggPickupSearchResult>(
        MaterialPageRoute(
          builder: (_) => EggPickupResultsPage(
            request: EggPickupSearchRequest(
              year: year,
              minDelay: minDelay,
              maxDelay: maxDelay,
              heldAdvance: 0,
  ...
  Gen4SeedCheckRequest? _buildHeldSeedCheckRequest(Gen4SeedTime seedTime) {
    ...
    return Gen4SeedCheckRequest(
      ...
      mode: Gen4SeedCheckMode.phoneCalls,
