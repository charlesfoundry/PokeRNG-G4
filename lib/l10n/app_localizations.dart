...
abstract class AppLocalizations {
  ...
  /// No description provided for @idRngTidRequired.
  ///
  /// In en, this message translates to:
  /// **'Please enter TID.'**
  String get idRngTidRequired;
